...
window.PORTFOLIO_DATA = {
  ...
  stations: [
    ...
    /* 5 — Proyectos Propios */
    {
      ...
      lines: ["backend", "frontend", "ia"],
      description: {
        es: "Proyecto final de carrera 'DICTA' ; un agente de IA para profesionales del derecho con múltiples herramientas para audiencias orales y grabadas (<a href='https://www.youtube.com/watch?v=mTzWbvQh-rw' target='_blank' rel='noopener noreferrer'>ver presentación</a>). Proyectos personales como: QuizCraft, plataforma para aprendizaje; AskGemini, skill para alexa; Talleres educativos sobre riesgos tecnológicos para niños y adolescentes. Proyectos freelance para clientes directos, droguerías, farmacias y laboratorios. Donde construyo mis propias ideas, de punta a punta.",
        en: "Final project DICTA; an AI agent for legal professionals with multiple tools for oral and recorded hearings (<a href='https://www.youtube.com/watch?v=mTzWbvQh-rw' target='_blank' rel='noopener noreferrer'>watch presentation</a>). Personal projects like: QuizCraft, a learning platform; AskGemini, an Alexa skill; Educational workshops on technological risks for children and adolescents. Freelance projects for direct clients, pharmacies, and laboratories. Where I build my own ideas, end to end.",
      },
      tags: [
